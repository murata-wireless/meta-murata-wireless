...
SRC_URI = " \
	...
	git://github.com/murata-wireless/cyw-bt-patch;protocol=http;branch=rocko-mini-baragon;destsuffix=cyw-bt-patch;name=cyw-bt-patch \
...
SRCREV_cyw-bt-patch="8b6d3404ef4a2652f26a4b5099410050aea1f0b9"
