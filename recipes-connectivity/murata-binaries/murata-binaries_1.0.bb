...
SRC_URI = " \
        ...
        git://github.com/Infineon/ifx-linux-firmware;protocol=http;destsuffix=cyw-fmac-fw-ifx;name=cyw-fmac-fw-ifx \
...
SRCREV_cyw-fmac-fw-ifx="1f566522104f69adab2639d798616db1fa795d66"
...
#   Copying FW and CLM BLOB files (*.bin, *.clm_blob) to lib/firmware/cypress folder
	...
	install -m 444 ${WORKDIR}/cyw-fmac-fw-ifx/cyfmac55572-pcie.trxse ${D}/${base_libdir}/firmware/cypress
    install -m 444 ${WORKDIR}/cyw-fmac-fw-ifx/cyfmac55572-sdio.trxse ${D}/${base_libdir}/firmware/cypress
