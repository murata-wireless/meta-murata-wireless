...
/usr/share/murata_wireless/ot-daemon "spinel+spi:///dev/spidev0.0?gpio-reset-device=/dev/gpiochip${gpio_reset_device}&gpio-int-device=/dev/gpiochip${gpio_int_device}&gpio-int-line=${gpio_int_line}&gpio-reset-line=${gpio_reset_line}&spi-mode=0&spi-speed=${bitrate}&spi-reset-delay=500" -d 5 > ot.log 2>&1 &
sleep 2
