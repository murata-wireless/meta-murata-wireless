...
echo "KERNEL_CONFIG_FRAGMENTS_append_am335x-evm = \" \${WORKDIR}/0001-murata-fmac-defconfig.cfg\"" >> ${TISDK_DIR}/sources/meta-processor-sdk/recipes-kernel/linux/linux-ti-staging_4.9.bbappend
