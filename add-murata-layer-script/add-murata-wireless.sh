...
echo "  - imx8mmevk.conf.conf present in sources/meta-fsl-bsp-release/imx/meta-bsp/conf/machine"
echo "  - imx8mmlpddr4evk.conf present in sources/meta-fsl-bsp-release/imx/meta-bsp/conf/machine"
echo "  - imx8mnevk.conf.conf present in sources/meta-fsl-bsp-release/imx/meta-bsp/conf/machine"
echo "  - imx8mnlpddr4evk.conf.conf.conf present in sources/meta-fsl-bsp-release/imx/meta-bsp/conf/machine"
echo ""
