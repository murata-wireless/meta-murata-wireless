...
cp ./sources/meta-murata-wireless/freescale/imx6dlsabresd.conf ./sources/meta-freescale/conf/machine/
cp ./sources/meta-murata-wireless/freescale/imx6qsabresd.conf ./sources/meta-freescale/conf/machine/
