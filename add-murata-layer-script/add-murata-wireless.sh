...
echo "KERNEL_CONFIG_FRAGMENTS_append_am335x-evm = \" \${WORKDIR}/0001-murata-fmac-defconfig.cfg\"" >> ${TISDK_DIR}/sources/meta-ti/meta-ti-bsp/recipes-kernel/linux/linux-ti-staging_6.1.bbappend
