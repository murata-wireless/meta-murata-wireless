...
SRC_URI =  "https://github.com/murata-wireless/cyw-fmac-v4.12-orga/raw/imx8-morty-orga/imx8-morty-orga_r1.0.tar.gz;name=archive1"
...
do_compile() {
	...
	# unset CFLAGS
        ...
        cp -a ${TMPDIR}/work/x86_64-linux/imx8-morty-orga/r1.0-r0/imx8-morty-orga-r1.0/. .
...
#KLIB_BUILD="${TMPDIR}/work/imx6ulevk-poky-linux-gnueabi/linux-imx/4.9.51-r0/build" \
#modules
}
